    ...
    def __init__(self):
        ...
        self.propuestas_pendientes: List[Dict[str, Any]] = [
            ...
            },
            {
                ...
                "impacto_en_sara": "Amparo IA alimenta el banco pericial de voces y Secure Vault sella el anonimato de la víctima.",
            ...
            {
                "id_propuesta": "PROP-OFICIAL-2025-012",
                "fecha_publicacion_oficial": "2025-11-04",
                "poder_del_estado": "Poder Ejecutivo / Sector Interior",
                "organo_emisor": "Ministerio del Interior (MININTER)",
                "norma": "Resolución Ministerial N.° 009-2025-IN",
                "titulo": "Lineamientos del Sector Interior para la Protección y Reserva de Identidad de Denunciantes en Delitos de Extorsión y Delitos Conexos",
                "materia": "SEGURIDAD_PUBLICA_Y_PROTECCION_DENUNCIANTE",
                "categoria": "CONFIDENCIALIDAD_Y_RESERVA_SECTOR_INTERIOR",
                "resumen_ejecutivo": "Establece la obligatoriedad de anonimización y reserva reforzada de denunciantes ante amenazas del crimen organizado.",
                "impacto_en_sara": "Habilita a SARA como canal tecnológico sectorial de recepción de denuncias protegidas.",
                "analisis_brecha_sara": "CERO BRECHAS: Implementación nativa en el Módulo 1 (Portal Ciudadano Zero-PII).",
                "estado": "APROBADO_E_INTEGRADO_EN_ASESOR_JURIDICO",
                "fuente_oficial_gob_pe": "https://www.gob.pe/institucion/mininter/normas-legales/7305448-009-2025-in",
                "dictamen_experto": "Plena armonización con los protocolos de recepción segura de denuncias del Sector Interior.",
                "fecha_decision": "2026-08-28",
                "aprobado_por": "Dra. Milagros Paredes Cárdenas (CAL 58492)"
            },
            {
                "id_propuesta": "PROP-OFICIAL-2025-013",
                "fecha_publicacion_oficial": "2025-12-15",
                "poder_del_estado": "Policía Nacional del Perú (PNP)",
                "organo_emisor": "Comandancia General de la PNP / COMOPPOL",
                "norma": "Resolución de la Comandancia General de la PNP N.° 1081-2025-CG-PNP/COMOPPOL",
                "titulo": "Guía de Procedimientos para otorgar la Medida de Reserva de Identidad a las Víctimas y Testigos del Delito de Extorsión en las Comisarías y Unidades Especializadas de la PNP",
                "materia": "PROCEDIMIENTO_POLICIAL_OPERATIVO",
                "categoria": "RESERVA_DE_IDENTIDAD_PNP",
                "resumen_ejecutivo": "Dispone el uso obligatorio de una clave alfanumérica y apertura del cuaderno especial de reserva para víctimas de extorsión.",
                "impacto_en_sara": "SARA automatiza la clave alfanumérica mediante el Código Único de Protección (CUP) y digitaliza el cuaderno especial en la Bóveda Zero-PII Cloud KMS.",
                "analisis_brecha_sara": "CERO BRECHAS: Automatización criptográfica en 0.05ms sin errores manuales de comisaría.",
                "estado": "APROBADO_E_INTEGRADO_EN_ASESOR_JURIDICO",
                "fuente_oficial_gob_pe": "https://www.gob.pe/institucion/pnp/normas-legales/7635816-1081-2025-cg-pnp-comoppol",
                "guia_doctrinal_consulta": "https://lpderecho.pe/guia-para-otorgar-reserva-de-identidad-a-victimas-de-extorsion/",
                "dictamen_experto": "Procedimiento policial operativo esencial que SARA ejecuta con precisión algorítmica inalterable.",
                "fecha_decision": "2026-08-28",
                "aprobado_por": "Coronel PNP (r) Víctor Manuel Rivas (DIRINCRI)"
            },
            {
                "id_propuesta": "PROP-OFICIAL-2026-014",
                "fecha_publicacion_oficial": "2026-01-14",
                "poder_del_estado": "Ministerio Público / Fiscalía de la Nación",
                "organo_emisor": "Fiscalía de la Nación / Coordinación Nacional FECOR",
                ...
                "materia": "DERECHO_PROCESAL_PENAL_FISCAL",
                "categoria": "PROTECCION_TESTIGOS_Y_VICTIMAS_FECOR",
                "resumen_ejecutivo": "Mecanismo excepcional de asignación de Código Reservado en investigaciones fiscales de extorsión contra transportistas y comerciantes.",
                "impacto_en_sara": "SARA conecta la clave policial con el Código Reservado de la Fiscalía permitiendo la remisión telemática de la Carpeta Fiscal en 1.8 segundos.",
                "analisis_brecha_sara": "CERO BRECHAS: Interoperabilidad directa en el Módulo 3 y Módulo 4 de SARA.",
                "estado": "APROBADO_E_INTEGRADO_EN_ASESOR_JURIDICO",
                ...
                "dictamen_experto": "Dispositivo crucial de la Fiscalía de la Nación y FECOR que valida procesalmente el CUP de SARA.",
                "fecha_decision": "2026-08-28",
                "aprobado_por": "Dr. Jorge Chávez Cotrina (Coordinador Nacional FECOR)"
            }
        ]
